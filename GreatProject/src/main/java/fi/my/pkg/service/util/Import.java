...
public class Import {
	...
	public Import(String importPath) {
		this.importPath = importPath;
	}

	public List<Book> importPdfBooks() throws Exception {
		return importBooks(PdfBook.class, importPath + "pdf");
	}
	...
	private String getTitle(String isbn) {
		return new Bison(importPath).getTitle(isbn);
	}
	...
	public List<Book> importAudioBooks() throws Exception {
		return importBooks(AudioBook.class, importPath + "audio");
	}
