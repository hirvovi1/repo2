...
class BookTest {
	...
	void testValidations() throws Exception {
		String msg = verifyException(IllegalArgumentException.class, 1, "", "title");
		assertMessage("isbn was blank string", msg);

		msg = verifyException(IllegalArgumentException.class, 1, null, "title");
		assertMessage("isbn was null", msg);

		msg = verifyException(IllegalArgumentException.class, 1, "abc", "title");
		assertMessage("invalid isbn abc", msg);

		msg = verifyException(IllegalArgumentException.class, 1, "978-952-264-186-1", null);
		assertMessage("title was null", msg);

		msg = verifyException(IllegalArgumentException.class, 0, "978-952-264-186-1", "title");
		assertMessage("invalid id 0", msg);
	}

	private String verifyException(Class type, int id, String isbn, String title) {
		Throwable e = Assertions.assertThrows(type, () -> {
